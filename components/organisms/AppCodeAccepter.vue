        ...
        <div
            ...
            <div class="relative z-10 h-full p-5 text-sm">
                <div class="flex flex-col items-center px-6 pt-8">
                    ...
                    <div class="mb-4 text-lg font-semibold">{{ userStore.currentUser.name }}</div>
                    <div class="mb-8 text-white/70">Thanks for joining Aladia.</div>
                    <div class="mb-8 text-center text-white/70">
                        Please enter the 6-digit code we sent you via email:
                    </div>
                    ...
                    <AppSubmitButton @click="submitCode" data-id="submit_code" />
                </div>
            </div>
        </div>
    </div>
